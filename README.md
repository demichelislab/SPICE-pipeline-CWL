...
sequencing data) [and](and) purity (fraction of tumor reads in the sequencing
data) of the tumor tissue. Purity and ploidy are known to affect copy number
values and allelic fractions of SNVs. Using such purity and ploidy estimates
CLONET is able to generate corrected copy numbers and SNVs. Moreover CLONET
outputs allele specific copy numbers (number of copies of the parental
alleles).
